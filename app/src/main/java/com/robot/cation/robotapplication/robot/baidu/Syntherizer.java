...
public class Syntherizer implements MainHandlerConstant {
    ...
    public Syntherizer(Context context, InitConfig initConfig, Handler mainHandler) {
        this(context, mainHandler);
        init(initConfig);
    }


    protected Syntherizer(Context context, Handler mainHandler) {
        if (isInitied) {
