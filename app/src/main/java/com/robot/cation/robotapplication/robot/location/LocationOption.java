package com.robot.cation.robotapplication.robot.location;
...
public class LocationOption {
    ...
    public static void initLocationOption(Context context, BaseApplication.LocationListener listener) {
