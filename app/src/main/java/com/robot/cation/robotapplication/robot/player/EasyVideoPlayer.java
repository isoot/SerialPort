...
public class EasyVideoPlayer extends FrameLayout
    ...
    private final Runnable mUpdateCounters =
        new Runnable() {
            ...
            public void run() {
                ...
                if (pos > dur) pos = dur;
                mLabelPosition.setText(PlayerUtil.getDurationString(pos, false));
                mLabelDuration.setText(PlayerUtil.getDurationString(dur - pos, true));
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mThemeColor =
                    a.getColor(
                        ...
                        PlayerUtil.resolveColor(context, R.attr.colorPrimary));
            ...
            mThemeColor = PlayerUtil.resolveColor(context, R.attr.colorPrimary);
    ...
    private void setSourceInternal() throws IOException {
        if (mSource.getScheme() != null
            ...
            LogUtils.w("Loading local URI: " + mSource.toString());
    ...
    protected void onFinishInflate() {
        ...
        ((FrameLayout) mClickFrame)
            .setForeground(PlayerUtil.resolveDrawable(getContext(), R.attr.selectableItemBackground));
        addView(
            mClickFrame,
        ...
        mLabelDuration.setText(PlayerUtil.getDurationString(0, true));
    ...
    private void tintSelector(@NonNull View view, @ColorInt int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP
            ...
            rd.setColor(ColorStateList.valueOf(PlayerUtil.adjustAlpha(color, 0.3f)));
        }
    }
