package com.robot.cation.robotapplication.robot.robot.led;
...
public class Led {
    ...
    public static void ledStart(int data) {
...
//        LogUtils.w("CRC校验之后的无符号数据:" + Arrays.toString(submit));
        ...
        Controller.startWrite(submit, ControllerRobot.ADVISEMENT_PLAYER, "您的广告正在配置中请稍后\n");
    }
}
