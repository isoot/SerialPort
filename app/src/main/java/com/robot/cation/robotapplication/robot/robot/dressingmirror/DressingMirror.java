package com.robot.cation.robotapplication.robot.robot.dressingmirror;
 ...
 * AR试衣镜
 */
public class DressingMirror {

    public static void dressingMirrorStart(int data) {
...
//        Controller.startWrite(submit, ControllerRobot.ICE_CREAM_MACHINE, "您的冰淇淋正在制作中请稍后\n");
    }
}
