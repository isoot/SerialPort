package com.robot.cation.robotapplication.robot.robot.lottery;
...
public class Lottery {
    public static void lotteryStart(int data) {
...
//        Controller.startWrite(submit, ControllerRobot.ICE_CREAM_MACHINE, "您的充电宝正在出货中请稍后\n");
    }
}
