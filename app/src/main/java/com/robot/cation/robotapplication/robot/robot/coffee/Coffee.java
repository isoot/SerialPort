package com.robot.cation.robotapplication.robot.robot.coffee;
...
public class Coffee {
    ...
    public static void coffeeStart(int data) {
...
//        LogUtils.w("CRC校验之后的无符号数据:" + Arrays.toString(submit));
        ...
        Controller.startWrite(submit, ControllerRobot.COFFEE_MAKER, "您的咖啡正在制作中请稍后\n");
    }
}
